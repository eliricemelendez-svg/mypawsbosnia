...
export const currentDogs: Dog[] = [
  {
    ...
    de: {
      ...
      description: "Flint ist seit seiner Welpenzeit im Tierheim. Vor Kurzem hat er Blut gespendet, um einem anderen Hund das Leben zu retten. Er ist immer noch einer der liebsten Hunde hier und wartet auf eine eigene Familie.",
      traits: [
    ...
    nl: {
      shortLine: "Een echte held. Knuffelig, heel goed met kinderen en loopt perfect aan de lijn.",
      description: "Flint zit al in het asiel sinds hij een pup was. Onlangs doneerde hij bloed om het leven van een andere hond te redden. Na al die tijd is hij nog steeds een van de liefste honden hier en hij wacht nog steeds op een eigen gezin.",
      traits: [
  ...
  },
  {
    ...
    nl: {
      ...
      description: "Leia werd achtergelaten bij ons asiel. Toch behield ze haar lieve karakter en vertrouwen in mensen. Ze is rustig, zelfverzekerd en heel sociaal. Ze heeft een thuis nodig met veel ruimte, en haar dikke vacht vraagt om regelmatige verzorging.",
      traits: [
    ...
    fr: {
      ...
      description: "Leia a \u00e9t\u00e9 abandonn\u00e9e devant notre refuge. Elle a quand m\u00eame gard\u00e9 son caract\u00e8re doux et sa confiance envers les humains. Elle est calme, s\u00fbre d\u2019elle et tr\u00e8s sociable. Elle a besoin d\u2019un foyer avec de l\u2019espace, et son pelage \u00e9pais demande un entretien r\u00e9gulier.",
      traits: [
  ...
  },
  {
    ...
    de: {
      ...
      description: "Klara ist eine von drei Schwestern, die im April 2026 in unserem Tierheim in Br\u010dko geboren wurden. Als junger Welpe wurde sie schwer krank, hat sich aber nach tier\u00e4rztlicher Behandlung und viel Pflege vollst\u00e4ndig erholt. Obwohl sie noch ein Welpe ist, ist Klara die ruhigste ihres Wurfs. Sie ist sanft, unkompliziert und am gl\u00fccklichsten, wenn sie einfach bei Menschen sein kann. Ihr Bruder wurde bereits nach Gro\u00dfbritannien adoptiert, und Klara wartet auf die gleiche Chance. Sie ist ein schwarzer Sch\u00e4ferhundmischling und wird etwa 25\u201330 kg wiegen.",
      traits: [
  ...
  },
  {
    ...
    nl: {
      shortLine: "Met de fles grootgebracht sinds 48 uur oud. Lief, speels en heel goed met kinderen en katten.",
    ...
    fr: {
      shortLine: "Nourri au biberon depuis ses 48 heures. Doux, joueur et il s'entend bien avec les enfants et les chats.",
  ...
  },
  {
    ...
    nl: {
      shortLine: "Met de fles grootgebracht sinds 48 uur oud. Speels, vriendelijk en heel goed met kinderen en katten.",
    ...
    fr: {
      shortLine: "Nourrie au biberon depuis ses 48 heures. Joueuse, amicale et elle adore les enfants et les chats.",
  ...
  },
  {
    ...
    ageYears: 3,
    size: "medium",
    shortLine: "Her whole family got adopted. She's the only one still waiting.",
    description: "Freya came to us from a public shelter in terrible condition. She was frightened, freezing, and overwhelmed. She arrived with her mother, brother, and two sisters. One by one, they all found homes. Everyone except Freya. She is gentle, sensitive, and loving. She is great with children, cats, and other dogs. She can lack confidence in new situations, so she would do best in a home with another calm, confident dog who can help her settle in. She already knows the basics of walking on a leash.",
    traits: [
      "Gentle, sensitive, and affectionate",
      "Great with children",
      "Good with cats",
      "Good with other dogs",
      "Spaniel-Setter mix, 14 kg, 43 cm",
      "Best with another confident dog in the home",
      "Knows leash basics",
      "Spayed, vaccinated, has a passport",
    ],
    de: {
      shortLine: "Ihre ganze Familie wurde adoptiert. Sie ist die Einzige, die noch wartet.",
      description: "Freya kam aus einem öffentlichen Tierheim in schrecklichem Zustand zu uns. Sie war verängstigt, durchgefroren und völlig überfordert. Sie kam zusammen mit ihrer Mutter, ihrem Bruder und zwei Schwestern. Nach und nach fanden alle ein Zuhause. Alle außer Freya. Sie ist sanft, sensibel und liebevoll. Sie versteht sich gut mit Kindern, Katzen und anderen Hunden. In neuen Situationen kann sie unsicher sein, deshalb wäre ein Zuhause mit einem ruhigen, selbstsicheren Hund ideal, der ihr hilft, sich einzuleben. An der Leine kennt sie schon die Grundlagen.",
      traits: [
        "Sanft, sensibel und anhänglich",
        "Toll mit Kindern",
        "Gut mit Katzen",
        "Gut mit anderen Hunden",
        "Spaniel-Setter-Mischling, 14 kg, 43 cm",
        "Am besten mit einem souveränen Zweithund",
        "Kennt Leinengrundlagen",
        "Kastriert, geimpft, hat einen Pass",
      ],
    },
    nl: {
      shortLine: "Haar hele familie werd geadopteerd. Zij is de enige die nog wacht.",
      description: "Freya kwam uit een openbaar asiel in verschrikkelijke staat bij ons. Ze was bang, ijskoud en totaal overweldigd. Ze kwam samen met haar moeder, broer en twee zussen. Een voor een vonden ze allemaal een thuis. Iedereen behalve Freya. Ze is zachtaardig, gevoelig en lief. Ze is goed met kinderen, katten en andere honden. In nieuwe situaties kan ze onzeker zijn, dus ze zou het beste gedijen in een huis met een rustige, zelfverzekerde hond die haar helpt om te wennen. Ze kent de basis van lopen aan de lijn.",
      traits: [
        "Zachtaardig, gevoelig en aanhankelijk",
        "Heel goed met kinderen",
        "Goed met katten",
        "Goed met andere honden",
        "Spaniel-Setter-mix, 14 kg, 43 cm",
        "Het best met een rustige tweede hond erbij",
        "Kent de basis aan de lijn",
        "Gesteriliseerd, gevaccineerd, heeft een paspoort",
      ],
    },
    fr: {
      shortLine: "Toute sa famille a été adoptée. Elle est la seule qui attend encore.",
      description: "Freya est arrivée chez nous depuis un refuge public dans un état terrible. Elle était terrifiée, gelée et complètement perdue. Elle est arrivée avec sa mère, son frère et ses deux sœurs. Un par un, ils ont tous trouvé un foyer. Tous sauf Freya. Elle est douce, sensible et affectueuse. Elle s'entend bien avec les enfants, les chats et les autres chiens. Elle peut manquer de confiance dans les situations nouvelles, c'est pourquoi elle serait idéale dans un foyer avec un autre chien calme et sûr de lui qui l'aiderait à s'adapter. Elle connaît déjà les bases de la marche en laisse.",
      traits: [
        "Douce, sensible et affectueuse",
        "Super avec les enfants",
        "Bien avec les chats",
        "Bien avec les autres chiens",
        "Croisée Spaniel-Setter, 14 kg, 43 cm",
        "Idéale avec un deuxième chien calme à la maison",
        "Connaît les bases en laisse",
        "Stérilisée, vaccinée, passeport en règle",
      ],
    },
  },
];
